export default class ViewLikometr {
  ...
  render = count => {
    const htmlStr = `
      <div class="progress-bar progress-bar-striped bg-success" role="progressbar" style="width: ${ count }%" 
      aria-valuenow="${ count }" aria-valuemin="0" aria-valuemax="100">${ count }</div>
    `;
